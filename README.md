...
自 2026-09-15 起，本仓库仅保留历史源码、提交和讨论记录，不再承接新功能。

后续开发统一到 **[AI替身整合仓库](https://github.com/wode1688/mouchen-private-alpha)**。该仓库为私有仓库，需要所有者授予访问权限；当前整合入口为 `codex/ai-twin-unified-20260915`（PR #7），合并前请勿将 `main` 当作最新整合版。

以下为旧版使用与开发资料，保留用于历史查阅。整合源码不代表已经完成生产部署或发布新的安装包。
